...
{
	uint8_t tmp[2];
	if(HAL_OK != HAL_I2C_Mem_Read(mlx90614_i2c, MLX90614_DEFAULT_ADDRESS, Register, I2C_MEMADD_SIZE_8BIT, tmp, 2, 10))
	{
...
MLX90614_STATUS MLX90614_Read16Eeprom(uint8_t Address, uint16_t *Result)
{
	...
	if(HAL_OK != HAL_I2C_Mem_Read(mlx90614_i2c, MLX90614_DEFAULT_ADDRESS, Address, I2C_MEMADD_SIZE_8BIT, tmp, 2, 10))
	{
		return MLX90614_ERROR;
	}
...
MLX90614_STATUS MLX90614_Write16Crc(uint8_t Address, uint16_t Value)
{
	...
	if(HAL_OK != HAL_I2C_Mem_Write(mlx90614_i2c, MLX90614_DEFAULT_ADDRESS, Address, I2C_MEMADD_SIZE_8BIT, tmp, 3, 10))
	{
		return MLX90614_ERROR;
	}
...
{
	float Result;
	Result = (float)Temperature * 0.02 - 273.15f;
